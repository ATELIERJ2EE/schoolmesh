            ...
            <ul class="notification-menu">
                ...
                <li>
                    ...
                    <div class="dropdown-menu dropdown-menu-head pull-right">
                        ...
                        <ul class="dropdown-list normal-list">
                            <li class="new">
                                <a href="">
                                    <span class="thumb"><img src="assets/back_end/images/photos/user1.png" alt="" /></span>
                                        <span class="desc">
                                          <span class="name">Camille <span class="badge badge-success">new</span></span>
                            ...
                            <li>
                                <a href="">
                                    <span class="thumb"><img src="assets/back_end/images/photos/user2.png" alt="" /></span>
                                        <span class="desc">
                            ...
                            <li>
                                <a href="">
                                    <span class="thumb"><img src="assets/back_end/images/photos/user3.png" alt="" /></span>
                                        <span class="desc">
                            ...
                            <li>
                                <a href="">
                                    <span class="thumb"><img src="assets/back_end/images/photos/user4.png" alt="" /></span>
                                        <span class="desc">
                            ...
                            <li>
                                <a href="">
                                    <span class="thumb"><img src="assets/back_end/images/photos/user5.png" alt="" /></span>
                                        <span class="desc">
                ...
                <li>
                    <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                        <img src="assets/back_end/images/photos/user-avatar.png" alt="" />
                        Camille
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="wdgt-profile">
                    <div class="profile">
                        <img src="assets/back_end/images/gallery/wdgt-img.jpg" alt=""/>
            ...
            <div class="col-md-4">
                <div class="panel widget-info-one">
                    <div class="avatar-img">
                        <img src="assets/back_end/images/gallery/image3.jpg" alt=""/>
                    </div>
                    <div class="inner">
                        <div class="avatar"><img alt="" src="assets/back_end/images/photos/userprofile.png"></div>
                        <h5>Margarita Rose</h5>
                            <span class="subtitle">
                    ...
                    <div class="panel-body">
                        <div class="dir-info">
                            <div class="row">
                                <div class="col-xs-3">
                                    <div class="avatar">
                                        <img src="assets/back_end/images/photos/user2.png" alt=""/>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <h5>Wild Awake</h5>
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <div class="avatar">
                                        <img src="assets/back_end/images/photos/user1.png" alt=""/>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <h5>Bulet Proof</h5>
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <div class="avatar">
                                        <img src="assets/back_end/images/photos/user3.png" alt=""/>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <h5>Bit it</h5>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <ul class="chats cool-chat">
                            <li class="in">
                                <img src="assets/back_end/images/photos/user1.png" alt="" class="avatar">
                                <div class="message">
                            ...
                            <li class="out">
                                <img src="assets/back_end/images/photos/user2.png" alt="" class="avatar">
                                <div class="message">
                                    <span class="arrow"></span>
                    ...
                    <div class="panel-body">
                        <div class="media usr-info">
                            <a href="#" class="pull-left">
                                <img class="thumb" src="assets/back_end/images/photos/user2.png" alt=""/>
                            </a>
